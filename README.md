...
* Home Assistant Blueprint pohja automaatiolle, joka varoittaa minkä tahans avaiheen ylittäessä määritetty virtaraja. 
* https://github.com/PilcQ/cozify_han/blob/main/blueprints/overcurrent_notification.yaml
